# Generated by Django 6.0.5 on 2026-05-22 19:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('age_group', models.CharField(choices=[('child', 'Child'), ('teen', 'Teen'), ('adult', 'Adult')], default='adult', max_length=10)),
                ...
                ('avatar', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='users', to='user.avatar')),
            ],
            options={
                'verbose_name': 'user',
